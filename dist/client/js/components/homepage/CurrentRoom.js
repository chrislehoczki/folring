...
var Room = function (_Component) {
	...
	_createClass(Room, [{
		...
		value: function leaveRoom() {
			(0, _socket.emit)('leave_room', { roomId: this.props.room._id, role: 'player' });
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ title: 'rejoin room', onClick: this.joinRoom.bind(this) },
						'Go to Room'
					),
					_react2.default.createElement(
						'button',
						{ title: 'leave room', onClick: this.leaveRoom.bind(this) },
						'Leave Room'
					)
				)
			);
